...
<center><h1>'O NEGATIVE BLOOD GROUP'<h1></center>
 <table cellpadding="20" cellspacing="20" width="800px" height="200px"  style="margin:auto"  >
...
$s="SELECT * FROM reg WHERE bg=\"O-\" AND DD<\"$sub\" and age>\"18\" order by DD asc ";
	...
	while($data=mysqli_fetch_array($result))
	{
				...
				<td style='color:steelblue' style=' padding-left:60px'>$data[9]</td></tr>";
			}
			mysqli_close($cn);
			?>
